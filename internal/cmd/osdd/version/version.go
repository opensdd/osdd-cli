...
// Get returns the injected version or "dev" if unset
func Get() string {
	if Version == "" {
		return "dev"
	}
...
// IsSet returns true if a Version was injected at build time
func IsSet() bool {
	return Version != ""
}

// Cmd returns the Cobra command for the version subcommand.
//
